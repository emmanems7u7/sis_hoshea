...
class SeederPermisos_20250625 extends Seeder
{
    ...
    {
        $permisos = [
            ['id' => 79, 'name' => 'Categorias', 'tipo' => 'menu', 'id_relacion' => 13, 'guard_name' => 'web'],
            ['id' => 78, 'name' => 'Ver Pacientes', 'tipo' => 'menu', 'id_relacion' => 12, 'guard_name' => 'web'],
            ['id' => 77, 'name' => 'Pacientes', 'tipo' => 'seccion', 'id_relacion' => 11, 'guard_name' => 'web'],
