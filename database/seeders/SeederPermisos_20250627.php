...
class SeederPermisos_20250627 extends Seeder
{
    ...
    {
        $permisos = [
            ['id' => 100, 'name' => 'Tratamientos', 'tipo' => 'menu', 'id_relacion' => 16, 'guard_name' => 'web'],
            ['id' => 99, 'name' => 'Citas', 'tipo' => 'menu', 'id_relacion' => 15, 'guard_name' => 'web'],
            ...
            ['id' => 86, 'name' => 'Inventario', 'tipo' => 'menu', 'id_relacion' => 14, 'guard_name' => 'web'],
