                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <label for="profile_picture" class="form-control-label text-black">Foto de Perfil</label>
                                    <div class="d-flex align-items-center">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name" class="form-control-label text-black">Nombre de usuario</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="email" class="form-control-label text-black">Email</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="usuario_nombres" class="form-control-label text-black">Nombre</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="usuario_app" class="form-control-label text-black">Apellido Paterno</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="usuario_apm" class="form-control-label text-black">Apellido Materno</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="usuario_telefono" class="form-control-label text-black">Teléfono</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="usuario_direccion" class="form-control-label text-black">Dirección</label>
