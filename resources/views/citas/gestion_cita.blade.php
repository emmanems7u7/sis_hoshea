    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-12">
                ...
                <div class="col-12">
                    <a href="#" class="btn btn-sm btn-danger btn-gestionar w-100  flex-column align-items-center py-3"
                        data-cita-id="{{ $cita->id }}"
                        data-gestionado="{{ $cita->gestionado }}"
                        {{ !$habilitado ? 'disabled' : '' }}>
...
<script>
   ...
   <!-- Modal -->
   @include('citas.modal_gestion')


@include('citas.modal_vista_gestion')

@include('citas.modal_hoja_lab')
